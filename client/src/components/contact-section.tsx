...
export default function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="py-20 gradient-overlay"
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16 reveal-up">
            ...
            >
              Join India's leading industries that trust BlueHawk Group for
              their quartz requirements.
            </p>
          </div>
                  ...
                  <div className="space-y-6" data-testid="contact-info">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">+44 7470 802451</p>
                      </div>
                    </div>
